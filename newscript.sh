...
docker run --rm -p 6443:443 --name phpldapadmin-service  --link ldap-service:localhost --env PHPLDAPADMIN_LDAP_HOSTS=10.100.102.29 --detach osixia/phpldapadmin:0.8.0
cd ..
